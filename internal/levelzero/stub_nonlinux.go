...
type Frequency struct{ Type uint32; OnSubdevice bool; SubdeviceID uint32 }
type Engine struct{ Type string; OnSubdevice bool; SubdeviceID uint32 }
type RAS struct{ ErrorType string; OnSubdevice bool; SubdeviceID uint32 }
type Memory struct{ Type string; OnSubdevice bool; SubdeviceID uint32; PhysicalSize uint64 }
